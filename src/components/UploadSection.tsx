...
const UploadSection = () => {
  ...
  return (
    <section id="upload" ref={ref} className="py-28 md:py-36 px-6 md:px-16">
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          <h2 className="font-display font-bold text-3xl md:text-[2.65rem] tracking-[0.05em] text-foreground mb-4">
        ...
        >
          {/* Upload area */}
          <div className="axis-card text-center py-20 mb-6 cursor-pointer group">
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            {guidelines.map((g) => (
              <div key={g} className="flex items-start gap-2">
                <div className="w-1 h-1 rounded-full bg-foreground/60 mt-1.5 shrink-0" />
